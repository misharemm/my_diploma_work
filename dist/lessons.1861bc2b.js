...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    const getAIResponse = async (userMessage)=>{
        try {
            ...
            if (!data.choices || data.choices.length === 0) throw new Error("No choices returned from API");
            const aiMessage = data.choices[0].message.content;
            return aiMessage;
        } catch (error) {
            console.error("Error fetching AI response:", error);
            return `\u{412}\u{438}\u{43D}\u{438}\u{43A}\u{43B}\u{430} \u{43F}\u{43E}\u{43C}\u{438}\u{43B}\u{43A}\u{430} \u{43F}\u{440}\u{438} \u{43E}\u{442}\u{440}\u{438}\u{43C}\u{430}\u{43D}\u{43D}\u{456} \u{432}\u{456}\u{434}\u{43F}\u{43E}\u{432}\u{456}\u{434}\u{456} \u{432}\u{456}\u{434} AI: ${error.message}`;
        }
    };
...
//# sourceMappingURL=lessons.1861bc2b.js.map
